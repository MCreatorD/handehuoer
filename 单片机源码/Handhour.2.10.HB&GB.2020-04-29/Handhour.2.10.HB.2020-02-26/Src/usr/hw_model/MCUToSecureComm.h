...
typedef struct MCU_TO_SECURE_FRAME{
	...
	uint8_t DataLen[2];        //帧长度,包括OperID和DataBuf的长度(字节0是长度低字节，1是长度高字节)
...
public:
  ...
  static  int getFrameContenLen(STRUCT_M2SEC_FRAME *pframe);
