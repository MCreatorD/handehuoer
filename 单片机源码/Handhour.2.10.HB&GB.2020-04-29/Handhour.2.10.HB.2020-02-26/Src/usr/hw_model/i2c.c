...
void I2C1_Configuration(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOB,ENABLE); //I2C1的脚使用
	
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1,ENABLE); //i2c clk使能
...
void I2C2_Configuration(void)
{
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C2,ENABLE); //i2c clk使能
...
uint32_t I2C_TIMEOUT_UserCallback(void)
{
  ...
  printf("The I2C communication is corrupted\n");
//  while (1)
//  {   
//  }
}
