...
#if (RF_USE_HBFPGA == 1)
	#define APP_VERSION_STR "VER:Handhour.2.11.HB.2020-04-29"
#else
	#define APP_VERSION_STR "VER:Handhour.2.10.GB.2020-02-26"
#endif
...
* 解决开始上报开始开机后配置激活失败问题2019/05/27
*	解决国标中读卡变盘点问题 修改读SPI时数据发送杂乱数据会让FPGA认为是c4 或者其他指令
* 解决写卡 转换函数的access组帧问题convertGBFrameToHBAccessFrame
* VER:Handhour.2.09.HB.2019-12-12
* 添加场强检测和反向速率调节
* VER:Handhour.2.10.HB.2020-02-26
* 测试国标行标读卡
* Handhour.2.11.HB.2020-04-29
* 添加行标读卡速率及读卡中低功耗 read_speed FPGA_LowPower
*/
...
private:
	...
	unsigned int  m_UpdatePackLen; //升级内容总包数
public:
	Update_SM_Firmware m_UpdateSM;
