...
private:
    ...
    CTagReportData* genTagReportData(vector<OpspecResult *> * pSelectResult,vector<OpspecResult *> * pAccessResults);
    ...
    CTagSelectAccessReport* genSelectAccessReport(int reportdata_count);
