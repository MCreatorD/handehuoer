...
#ifndef GB_RF_MODE
//    while(1){//注意，此处可能会存在死锁
//        //printf("B0..................\n");
//        //printf("B2..................\n");
//        STRUCT_M2SEC_FRAME *pframe = m_pRfOper->readSMBuff();
//        //printf("B3..................\n");
//        if(pframe!=NULL){
//            printf("clear one secure module buf!\n");
...
//        printf("Do auto Cancellation!======================================\n");
//         //简化为只取第一条天线参数
//        CAntennaSpec *pantspec = *(pSpec->getSelectSpec()->beginAntennaSpec());
//        if(m_pRfOper->setAllADParam(pantspec)==false){
//            printf("Cancellation is fail!Retry..............!\n");
//            if(m_pRfOper->setAllADParam(pantspec)==false){
//                printf("Cancellation is fail!\n");
//            }else{
//                printf("Cancellation is success!\n");
//            }
//        }else{
//            printf("Cancellation is success!\n");
//        }

//        string res = m_pRfOper->convertADDataToString();
//        printf("Auto Cancellation Res is : %s\n",res.c_str());
//        printf("Cancellation is finish!==================================================\n");
//    }
#endif
        ...
        if(ptagobtrg!=NULL){
            ...
            case TriggerType_NLabels://标签个数达到，或超时
            {
                ...
                if(m_TagObTagNCount>=n){
                    ...
                    llrp_u64_t currentutc = General_Functions::getCurrentUTC();
                    if(currentutc-m_TagObTrgStartUTC>=timeout&&timeout!=0){
												//让开始的gpi触发停止
												KEY_TYPE = TRIG_UP;
                        isstop = true;
                    }else{
...
void OperationSpec_Execute_Base::pushOpResult(OpspecResult *pOpResult){
 ...
 void OperationSpec_Execute_Base::pushSelectAccessResult(Tag_SelectAccessResult *pSelectAccessResult){
     ...
     if(m_SelectAccessResults.size()>100){
         return;
     }
