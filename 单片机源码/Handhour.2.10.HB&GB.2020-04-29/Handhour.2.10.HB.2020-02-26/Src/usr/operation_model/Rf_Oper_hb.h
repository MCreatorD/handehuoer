...
//2018.10.10新加
public:
	bool isPrivateWriteOper; //该变量未用，不起作用
public:
	STRUCT_M2SEC_FRAME* sendPrivateWriteRequest(CHbPrivateWriteSpec *spec);
	void setDefaultSecParam();
	STRUCT_M2SEC_FRAME* getPrivateWriteACK();

	bool setPrivateWriteAB();
};
