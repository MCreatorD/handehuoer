...
/////////////////////////////////////////////////
/**
 * @brief The CDiagnosticTestResultTemperature class
 * 温度检测
 */

class CDiagnosticTestResultTemperature : public CParameter
{
  public:
    CDiagnosticTestResultTemperature (void);
    ~CDiagnosticTestResultTemperature (void);
...
//@}
  ...
  protected:
    llrp_s32_t  m_Temperature; //温度值乘以100
...
/**
 * @brief The CDiagnosticTestResultPowerVoltage class
 * 电压检测
 */

class CDiagnosticTestResultPowerVoltage : public CParameter
{
  public:
    CDiagnosticTestResultPowerVoltage (void);
    ~CDiagnosticTestResultPowerVoltage (void);
...
//@}
  ...
  protected:
    llrp_s32_t  m_PowerVoltage; //电压值乘以100
...
/**
 * @brief The CDiagnosticTestResultCPURamUsage class
 * CPU，内存占用率检测
 */

class CDiagnosticTestResultCPURamUsage : public CParameter
{
  public:
    CDiagnosticTestResultCPURamUsage (void);
    ~CDiagnosticTestResultCPURamUsage (void);
...
//@}
  ...
  protected:
    llrp_u32_t  m_CPUUsage; //百分点
    llrp_u32_t m_RamUsage; //多少M
