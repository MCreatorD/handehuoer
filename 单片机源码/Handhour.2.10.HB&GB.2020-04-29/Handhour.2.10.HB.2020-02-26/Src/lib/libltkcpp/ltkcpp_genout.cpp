  ...
  CTypeRegistry *               pTypeRegistry)
{
    ...
    pTypeRegistry->enroll(&CDiagnosticTestResultTemperature::s_typeDescriptor);

    pTypeRegistry->enroll(&CDiagnosticTestResultPowerVoltage::s_typeDescriptor);

    pTypeRegistry->enroll(&CDiagnosticTestResultCPURamUsage::s_typeDescriptor);
	...
	pTypeRegistry->enroll(&CHbPrivateWriteSpec::s_typeDescriptor);
	...
	pTypeRegistry->enroll(&CHbPrivateWriteSpecResult::s_typeDescriptor);
