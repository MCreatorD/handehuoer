...
class CHbPrivateWriteSpecResult;
...
/**
 ** @brief  Class Definition CHbPrivateWriteSpec for LLRP parameter HbWriteSpec
 **	2018.10.10ÐÂ¼Ó
 **/

class CHbPrivateWriteSpec : public CParameter
{
  public:
    CHbPrivateWriteSpec (void);
    ~CHbPrivateWriteSpec (void);
...
/**
 ** @brief  Class Definition CHbPrivateWriteSpecResult for LLRP parameter HbPrivateWriteSpecResult
 **
...
class CHbPrivateWriteSpecResult : public CParameter
{
  public:
    CHbPrivateWriteSpecResult (void);
    ~CHbPrivateWriteSpecResult (void);
