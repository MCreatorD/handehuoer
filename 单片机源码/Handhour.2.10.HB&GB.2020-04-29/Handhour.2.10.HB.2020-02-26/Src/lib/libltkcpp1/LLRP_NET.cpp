...
EResultCode
CGetDeviceConfig::setSecurityModuleConfiguration (
...
const CFieldDescriptor
CSecurityModuleConfiguration::s_fdConfigData =
{
    CFieldDescriptor::FT_U8V,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "ConfigData",	// m_pName
  ...
  CElement *                    pTargetElement)
{
    ...
    if(NULL != pTarget)
    {
        pTarget->m_ConfigData = pDecoderStream->get_u8v(&s_fdConfigData);
    }
    else
    {
        pDecoderStream->get_u8v(&s_fdConfigData);
    }
}
  ...
  CEncoderStream *              pEncoderStream) const
{
	...
	pEncoderStream->put_u8v(m_ConfigData, &s_fdConfigData);
...
*****************************************************************
**
** Parameter CDiagnosticTestResultTemperature
**
*****************************************************************
*/
...
const CTypeDescriptor
CDiagnosticTestResultTemperature::s_typeDescriptor =
{
    FALSE,		// m_bIsMessage
    "DiagnosticTestResultTemperature",	// m_pName
    NULL,	// m_pVendorDescriptor
    &g_nsdescllrp,	// m_pNamespaceDescriptor
    900,	// m_TypeNum
    NULL,    // m_pResponseType
...
const CFieldDescriptor * const
CDiagnosticTestResultTemperature::s_apFieldDescriptorTable[] =
{
...
const CFieldDescriptor
CDiagnosticTestResultTemperature::s_fdTemperature =
{
...
CDiagnosticTestResultTemperature::CDiagnosticTestResultTemperature (void)
{
    m_pType = &s_typeDescriptor;
...
CElement *
CDiagnosticTestResultTemperature::s_construct (void)
{
    return (CElement *) new CDiagnosticTestResultTemperature();
}


void
CDiagnosticTestResultTemperature::s_decodeFields (
  CDecoderStream *              pDecoderStream,
  CElement *                    pTargetElement)
{
    CDiagnosticTestResultTemperature * pTarget = (CDiagnosticTestResultTemperature *) pTargetElement;


    if(NULL != pTarget)
    {
        pTarget->m_Temperature = pDecoderStream->get_s32(&s_fdTemperature);
    }
    else
    {
        pDecoderStream->get_s32(&s_fdTemperature);
    }
...
void
CDiagnosticTestResultTemperature::decodeFields (
  CDecoderStream *              pDecoderStream)
{
    s_decodeFields(pDecoderStream, (CElement *)this);
}
...
void
CDiagnosticTestResultTemperature::assimilateSubParameters (
  CErrorDetails *               pError)
{
    tListOfParameters::iterator Cur = m_listAllSubParameters.begin();
    tListOfParameters::iterator End = m_listAllSubParameters.end();
...
void
CDiagnosticTestResultTemperature::encode (
  CEncoderStream *              pEncoderStream) const
{
    const CTypeDescriptor *     pType;


    pEncoderStream->put_s32(m_Temperature, &s_fdTemperature);
...
*****************************************************************
**
** Parameter CDiagnosticTestResultPowerVoltage
**
*****************************************************************
*/
...
const CTypeDescriptor
CDiagnosticTestResultPowerVoltage::s_typeDescriptor =
{
    FALSE,		// m_bIsMessage
    "DiagnosticTestResultPowerVoltage",	// m_pName
    NULL,	// m_pVendorDescriptor
    &g_nsdescllrp,	// m_pNamespaceDescriptor
    901,	// m_TypeNum
    NULL,    // m_pResponseType
...
const CFieldDescriptor * const
CDiagnosticTestResultPowerVoltage::s_apFieldDescriptorTable[] =
{
...
const CFieldDescriptor
CDiagnosticTestResultPowerVoltage::s_fdPowerVoltage =
{
    CFieldDescriptor::FT_S32,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "PowerVoltage",	// m_pName
    NULL	// m_pEnumTable
};

CDiagnosticTestResultPowerVoltage::CDiagnosticTestResultPowerVoltage (void)
{
    m_pType = &s_typeDescriptor;
...
CElement *
CDiagnosticTestResultPowerVoltage::s_construct (void)
{
    return (CElement *) new CDiagnosticTestResultPowerVoltage();
}


void
CDiagnosticTestResultPowerVoltage::s_decodeFields (
  CDecoderStream *              pDecoderStream,
  CElement *                    pTargetElement)
{
    CDiagnosticTestResultPowerVoltage * pTarget = (CDiagnosticTestResultPowerVoltage *) pTargetElement;


    if(NULL != pTarget)
    {
        pTarget->m_PowerVoltage = pDecoderStream->get_s32(&s_fdPowerVoltage);
    }
    else
    {
        pDecoderStream->get_s32(&s_fdPowerVoltage);
    }
...
void
CDiagnosticTestResultPowerVoltage::decodeFields (
  CDecoderStream *              pDecoderStream)
{
    s_decodeFields(pDecoderStream, (CElement *)this);
}
...
void
CDiagnosticTestResultPowerVoltage::assimilateSubParameters (
  CErrorDetails *               pError)
{
    tListOfParameters::iterator Cur = m_listAllSubParameters.begin();
    tListOfParameters::iterator End = m_listAllSubParameters.end();
...
void
CDiagnosticTestResultPowerVoltage::encode (
  CEncoderStream *              pEncoderStream) const
{
    const CTypeDescriptor *     pType;


    pEncoderStream->put_s32(m_PowerVoltage, &s_fdPowerVoltage);
...
*****************************************************************
**
** Parameter CDiagnosticTestResultCPURamUsage
**
*****************************************************************
*/
...
const CTypeDescriptor
CDiagnosticTestResultCPURamUsage::s_typeDescriptor =
{
    FALSE,		// m_bIsMessage
    "DiagnosticTestResultCPURamUsage",	// m_pName
    NULL,	// m_pVendorDescriptor
    &g_nsdescllrp,	// m_pNamespaceDescriptor
    902,	// m_TypeNum
    NULL,    // m_pResponseType
...
const CFieldDescriptor * const
CDiagnosticTestResultCPURamUsage::s_apFieldDescriptorTable[] =
{
...
const CFieldDescriptor
CDiagnosticTestResultCPURamUsage::s_fdCPUUsage =
{
    CFieldDescriptor::FT_U32,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "CPUUsage",	// m_pName
...
const CFieldDescriptor
CDiagnosticTestResultCPURamUsage::s_fdRamUsage =
{
    CFieldDescriptor::FT_U32,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "RamUsage",	// m_pName
...
CDiagnosticTestResultCPURamUsage::CDiagnosticTestResultCPURamUsage (void)
{
    m_pType = &s_typeDescriptor;
...
CElement *
CDiagnosticTestResultCPURamUsage::s_construct (void)
{
    return (CElement *) new CDiagnosticTestResultCPURamUsage();
}


void
CDiagnosticTestResultCPURamUsage::s_decodeFields (
  CDecoderStream *              pDecoderStream,
  CElement *                    pTargetElement)
{
    CDiagnosticTestResultCPURamUsage * pTarget = (CDiagnosticTestResultCPURamUsage *) pTargetElement;


    if(NULL != pTarget)
    {
        pTarget->m_CPUUsage = pDecoderStream->get_u32(&s_fdCPUUsage);
    }
    else
    {
        pDecoderStream->get_u32(&s_fdCPUUsage);
    }

    if(NULL != pTarget)
    {
        pTarget->m_RamUsage = pDecoderStream->get_u32(&s_fdRamUsage);
    }
    else
    {
        pDecoderStream->get_u32(&s_fdRamUsage);
    }
}


void
CDiagnosticTestResultCPURamUsage::decodeFields (
  CDecoderStream *              pDecoderStream)
{
    s_decodeFields(pDecoderStream, (CElement *)this);
}
...
void
CDiagnosticTestResultCPURamUsage::assimilateSubParameters (
  CErrorDetails *               pError)
{
    tListOfParameters::iterator Cur = m_listAllSubParameters.begin();
    tListOfParameters::iterator End = m_listAllSubParameters.end();
...
void
CDiagnosticTestResultCPURamUsage::encode (
  CEncoderStream *              pEncoderStream) const
{
    //const CTypeDescriptor *     pType;


    pEncoderStream->put_u32(m_CPUUsage, &s_fdCPUUsage);

    pEncoderStream->put_u32(m_RamUsage,&s_fdRamUsage);
}
  ...
  CParameter *                  pParameter)
{
    ...
    if(&CDiagnosticTestResultTemperature::s_typeDescriptor == pType)
    {
        return TRUE;
    }

    if(&CDiagnosticTestResultPowerVoltage::s_typeDescriptor == pType)
    {
        return TRUE;
    }

    if(&CDiagnosticTestResultCPURamUsage::s_typeDescriptor == pType)
    {
        return TRUE;
    }
