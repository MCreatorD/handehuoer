...
const CTypeDescriptor
CHbPrivateWriteSpec::s_typeDescriptor =
{
    FALSE,		// m_bIsMessage
    "HbPrivateWriteSpec",	// m_pName
    NULL,	// m_pVendorDescriptor
    &g_nsdescllrp,	// m_pNamespaceDescriptor
    459,	// m_TypeNum
    NULL,    // m_pResponseType
...
const CFieldDescriptor * const
CHbPrivateWriteSpec::s_apFieldDescriptorTable[] =
{
...
const CFieldDescriptor
CHbPrivateWriteSpec::s_fdOpSpecID =
{
    CFieldDescriptor::FT_U16,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "OpSpecID",	// m_pName
...
const CFieldDescriptor
CHbPrivateWriteSpec::s_fdWriteType =
{
    CFieldDescriptor::FT_U8,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "WriteType",	// m_pName
...
CHbPrivateWriteSpec::CHbPrivateWriteSpec (void)
{
    m_pType = &s_typeDescriptor;
...
CElement *
CHbPrivateWriteSpec::s_construct (void)
{
    return (CElement *) new CHbPrivateWriteSpec();
}


void
CHbPrivateWriteSpec::s_decodeFields (
  CDecoderStream *              pDecoderStream,
  CElement *                    pTargetElement)
{
    CHbPrivateWriteSpec * pTarget = (CHbPrivateWriteSpec *) pTargetElement;
    ...
    if(NULL != pTarget)
    {
        pTarget->m_WriteType = pDecoderStream->get_u8(&s_fdWriteType);
    }
    else
    {
        pDecoderStream->get_u8(&s_fdWriteType);
    }
...
void
CHbPrivateWriteSpec::decodeFields (
  CDecoderStream *              pDecoderStream)
{
    s_decodeFields(pDecoderStream, (CElement *)this);
}
...
void
CHbPrivateWriteSpec::assimilateSubParameters (
  CErrorDetails *               pError)
{
    tListOfParameters::iterator Cur = m_listAllSubParameters.begin();
    tListOfParameters::iterator End = m_listAllSubParameters.end();
  ...
  CEncoderStream *              pEncoderStream) const
{
    ...
    pEncoderStream->put_u8(m_WriteType, &s_fdWriteType);
...
*****************************************************************
**
** Parameter HbPrivateWriteSpecResult
**
*****************************************************************
*/
...
const CTypeDescriptor
CHbPrivateWriteSpecResult::s_typeDescriptor =
{
    FALSE,		// m_bIsMessage
    "HbPrivateWriteSpecResult",	// m_pName
    NULL,	// m_pVendorDescriptor
    &g_nsdescllrp,	// m_pNamespaceDescriptor
    514,	// m_TypeNum
    NULL,    // m_pResponseType
...
const CFieldDescriptor * const
CHbPrivateWriteSpecResult::s_apFieldDescriptorTable[] =
{
...
const CFieldDescriptor
CHbPrivateWriteSpecResult::s_fdResult =
{
    CFieldDescriptor::FT_U8,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "Result",	// m_pName
...
const CFieldDescriptor
CHbPrivateWriteSpecResult::s_fdResultDescription =
{
    CFieldDescriptor::FT_U8V,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "ResultDescription",	// m_pName
...
const CFieldDescriptor
CHbPrivateWriteSpecResult::s_fdOpSpecID =
{
    CFieldDescriptor::FT_U16,	// m_EFieldType
    CFieldDescriptor::FMT_NORMAL,	// m_EFieldFormat
    "OpSpecID",	// m_pName
...
CHbPrivateWriteSpecResult::CHbPrivateWriteSpecResult (void)
{
    m_pType = &s_typeDescriptor;
...
CElement *
CHbPrivateWriteSpecResult::s_construct (void)
{
    return (CElement *) new CHbPrivateWriteSpecResult();
}


void
CHbPrivateWriteSpecResult::s_decodeFields (
  CDecoderStream *              pDecoderStream,
  CElement *                    pTargetElement)
{
    CHbPrivateWriteSpecResult * pTarget = (CHbPrivateWriteSpecResult *) pTargetElement;
...
void
CHbPrivateWriteSpecResult::decodeFields (
  CDecoderStream *              pDecoderStream)
{
    s_decodeFields(pDecoderStream, (CElement *)this);
}
...
void
CHbPrivateWriteSpecResult::assimilateSubParameters (
  CErrorDetails *               pError)
{
    tListOfParameters::iterator Cur = m_listAllSubParameters.begin();
    tListOfParameters::iterator End = m_listAllSubParameters.end();
...
void
CHbPrivateWriteSpecResult::encode (
  CEncoderStream *              pEncoderStream) const
{
    const CTypeDescriptor *     pType;
  ...
  CParameter *                  pParameter)
{
	...
	if(&CHbPrivateWriteSpec::s_typeDescriptor == pType)
    {
        return TRUE;
    }
  ...
  CParameter *                  pParameter)
{
    ...
    if(&CHbWriteSpecResult::s_typeDescriptor == pType)
    {
		...
		if(&CHbPrivateWriteSpecResult::s_typeDescriptor == pType)
    {
        return TRUE;
    }
